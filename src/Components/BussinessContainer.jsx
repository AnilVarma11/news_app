...
const BussinessContainer = () => {
    ...
    const API_URL = "https://newsapi.org/v2/top-headlines?country=in&us&category=business&apiKey=6e141b98997d40fcb539f0bb6825e17e";
    ...
    return (
        <div>
              <h1 className='sport-title'>More in <span>Bussiness</span> </h1>
